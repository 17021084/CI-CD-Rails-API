...
ActiveRecord::Schema.define(version: 2021_01_13_155150) do
  ...
  create_table "balls", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "name"
    t.string "size"
